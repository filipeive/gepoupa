...
<div class="d-flex justify-content-between">
    ...
    <div>
        <a href="{{ route('interest-distributions.export') }}" class="btn btn-success">
            <i class="fas fa-file-excel"></i> Exportar
        </a>
        <a href="{{ route('interest-distributions.create') }}" class="btn btn-primary">
            ...
            <tbody>
                @foreach($distributions as $distribution)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('interest-distributions.show', $distribution) }}" class="btn btn-sm btn-info">
